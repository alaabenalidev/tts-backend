...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        boolean adminRole =request.getRole() == Role.ADMIN || request.getRole() == Role.SUPERADMIN;
        var user = User.builder()
                ...
                .accountStatus(adminRole ? AccountStatus.ACCEPTED : AccountStatus.REQUEST)
                .accountLocked(false)
                .enabled(request.getRole() == Role.ADMIN || request.getRole() == Role.SUPERADMIN)
                .build();
